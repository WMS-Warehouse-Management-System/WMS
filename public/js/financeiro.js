...
//---Inserir dados no BD
document.getElementById('formContainer').addEventListener('submit', async function (e) {
  e.preventDefault();
  ...
  const response = await fetch('http://localhost:3000/financeiro', {
      ...
      body: JSON.stringify({ Nome: nome, Data: data, Quantidade: quantidade, Codigo: codigo, Validade: validade, Lote: lote, Fornecedor: fornecedor })
  });
